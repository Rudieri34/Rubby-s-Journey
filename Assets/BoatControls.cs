...
public partial class @BoatControls: IInputActionCollection2, IDisposable
{
    ...
    ~@BoatControls()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, BoatControls.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, BoatControls.UI.Disable() has not been called.");
    }
    ...
    public struct PlayerActions
    {
        ...
        /// </summary>
        public PlayerActions(@BoatControls wrapper) { m_Wrapper = wrapper; }
        /// <summary>
